const oloSlider = (sliderContainer = '.slider',
                   slideList = '.slider-list',
                   slideTrack = '.slider-track',
                   slideElement = '.slide',
                   sliderArrows = '.slider-arrows') => {
    let slider = document.querySelector(sliderContainer),
        sliderList = slider.querySelector(slideList),
        sliderTrack = slider.querySelector(slideTrack),
        slides = slider.querySelectorAll(slideElement),
